...
import { PricingRevenueQualitySection } from '@/components/historical/PricingRevenueQualitySection';
...
const GROVE_KEY = 'THE_GROVE';

type PropertyKey = typeof PITTMAN_KEY | typeof GROVE_KEY;
...
const PROPERTY_OPTIONS: PropertyOption[] = [
  { id: PITTMAN_KEY, label: 'STORE on Pittman', city: 'Fairfield, CA' },
  { id: GROVE_KEY, label: 'STORE on the Grove', city: 'Phoenix, AZ' },
];
...
const PROPERTY_SERIES: Record<PropertyKey, MoMSeries | null> = {
  [PITTMAN_KEY]: getMoMSeries(PITTMAN_KEY),
  [GROVE_KEY]: getMoMSeries(GROVE_KEY),
};
...
export default function HistoricalDataPage(): JSX.Element {
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm text-[color:var(--text-secondary)]">
                  Facility performance trends across occupancy, revenue, and unit mix. Data shown is placeholder until
                  the historical pipeline is wired in.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2 rounded-full border border-[color:var(--border-soft)] bg-[color:var(--surface)] px-3 py-1 shadow-inner">
                ...
                <select
                  ...
                  onChange={(event) => setSelectedProperty(event.target.value as PropertyKey)}
                >
          ...
          <div className="ios-card ios-animate-up space-y-6 p-6">
            ...
            >
              ...
              >
                ...
                <path
                  d={occupancyArea}
                  fill="url(#history-occupancy-area)"
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-[color:var(--text-secondary)]">
              <div className="ios-list-card flex items-center gap-3 px-4 py-2">
                <div>
                  <div className="text-[11px] uppercase tracking-wide text-[color:var(--text-muted)]">Latest occupancy</div>
                  <div className="text-lg font-semibold text-[color:var(--text-primary)]">
                    {OCCUPANCY_SERIES[OCCUPANCY_SERIES.length - 1]}%
                  </div>
                </div>
              </div>
              <div className="ios-list-card flex items-center gap-3 px-4 py-2">
                <div>
                  ...
                  <div className="text-lg font-semibold text-[color:var(--text-primary)]">
                    {RATE_INDEX_SERIES[RATE_INDEX_SERIES.length - 1]}
                  </div>
                </div>
              </div>
              <div className="ios-list-card flex items-center gap-3 px-4 py-2">
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-wrap items-center justify-between gap-4 sm:justify-end">
                      ...
                      <div className="text-right">
                        <div className="text-[11px] uppercase tracking-wide text-[color:var(--text-muted)]">Occupancy</div>
