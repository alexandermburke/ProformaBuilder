        ...
        <div className="flex flex-wrap gap-2">
          {value.method === 'PercentOfRevenue' && (
            <input
              type="number"
              step="0.001"
              className="h-9 w-36 rounded-lg border border-[#E5E7EB] px-2 text-sm"
    ...
    <div className="min-h-screen w-full bg-white text-[#111827]">
      <div className="mx-auto max-w-[1440px] p-6">
        <div className="grid grid-cols-[260px_minmax(0,1fr)] gap-6">
          {/* Sidebar */}
          <aside className="rounded-[14px] border border-[#E5E7EB] bg-white shadow-sm">
            <div className="px-5 py-6">
              <div className="mb-6 text-[22px] font-semibold tracking-tight">STORE</div>
              <nav className="flex flex-col gap-1">
                <a
                  className="rounded-lg px-3 py-2 text-[14px] font-medium text-[#1F2937] outline-none ring-0 transition hover:bg-[#F3F4F6] data-[active=true]:bg-[#EEF2FF] data-[active=true]:text-[#1E40AF]"
                  data-active="true"
                  href="#create"
                >
                  Create Report
                ...
                <Link
                  className="rounded-lg px-3 py-2 text-[14px] font-medium text-[#4B5563] outline-none ring-0 transition hover:bg-[#F3F4F6]"
                  href="/snapshots"
                  id="snapshots-link"
              ...
              <div className="rounded-[14px] border border-[#E5E7EB] bg-white p-5 shadow-sm">
                ...
                {step === 0 && (
                  <div className="space-y-5">
                    ...
                    <div className="flex gap-2">
                      <button
                        className="h-10 rounded-lg border border-[#D1D5DB] px-4 text-sm text-[#111827]"
                ...
                {step === 1 && parseResult && (
                  <div className="space-y-5">
                    ...
                    <div className="flex gap-2">
                      <button className="h-10 rounded-lg border border-[#D1D5DB] px-4 text-sm" onClick={prev}>
                        Back
                      </button>
                      <button
                        className="h-10 rounded-lg bg-[#2563EB] px-4 text-sm font-medium text-white"
                        onClick={() => setStep(2)}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      <label className="text-sm">
                        ...
                        <input
                          className="h-10 w-full rounded-lg border border-[#D1D5DB] px-3 text-sm"
                          value={facility}
                    ...
                    <div className="rounded-xl border border-[#E5E7EB] p-4 space-y-4">
                      ...
                      <div className="text-[12px] text-[#9CA3AF]">
                        Tip: use negative percent for discounts/bad debt (e.g., −0.02).
                      </div>
                    </div>

                    <div className="grid gap-3 rounded-xl border border-[#DBEAFE] bg-[#F5F7FF] p-4 text-xs text-[#1E3A8A] sm:grid-cols-2">
                      <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <button className="h-10 rounded-lg border border-[#D1D5DB] px-4 text-sm" onClick={buildPreviewSeries}>
                        Preview Series
                      </button>
                      <button
                        className="h-10 rounded-lg bg-[#2563EB] px-4 text-sm font-medium text-white"
                ...
                {step === 4 && (
                  <div className="space-y-5">
                    <div>
                      ...
                      <div className="mt-1 text-sm text-[#6B7280]">
                        Period <span className="tabular-nums">{period}</span> · Facility {facility}
                      </div>
                    </div>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                      {previewStats.map((stat) => (
                        <div
                          key={stat.key}
                          className="rounded-xl border border-[#E5E7EB] bg-[#F3F4F6] p-4"
                        >
                    ...
                    <div className="mb-1 flex flex-wrap items-center gap-4 text-[14px]">
                      <span className="flex items-center gap-2">
                        <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-[#DEF7EC] text-[#065F46]">
                          ✓
                        </span>
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      <button
                        ...
                        className="inline-flex h-10 items-center justify-center rounded-lg border border-[#2563EB] px-4 text-sm font-medium text-[#1E40AF] transition hover:bg-[#EFF6FF]"
                      ...
                      <button
                        ...
                        className="inline-flex h-10 items-center justify-center rounded-lg bg-[#2563EB] px-4 text-sm font-medium text-white transition hover:bg-[#1E3A8A]"
                      >
                        Save Owner PDF
                      </button>
                    </div>
