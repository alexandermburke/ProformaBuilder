      ...
      <main className="relative mx-auto flex max-w-6xl flex-col gap-10 px-6 py-12 lg:gap-12 lg:px-10 lg:py-16">
        ...
        <section className="grid gap-5 lg:grid-cols-5">
          <div className="ios-card ios-animate-up lg:col-span-3 p-6">
            ...
            <div className="mt-4 rounded-2xl border border-[color:var(--border-soft)]/70 bg-[color:var(--surface)]/80 p-5 shadow-sm">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="space-y-1">
                  <p className="text-xs font-semibold uppercase tracking-wide text-[color:var(--text-muted)]">Outputs</p>
                  <h3 className="text-lg font-semibold text-[color:var(--text-primary)]">Download file</h3>
                  <p className="text-sm text-[color:var(--text-secondary)]">
                    Upload the processed spreadsheet first, then download the combined output when ready.
                  </p>
                </div>
              </div>
              <div className="mt-3 grid gap-3">
                <div className="flex items-center justify-between rounded-lg border border-[color:var(--border-soft)]/70 bg-[color:var(--surface)]/80 px-4 py-3">
                  <span className="text-sm font-semibold text-[color:var(--text-primary)]">Output spreadsheet</span>
                  <button
                    type="button"
                    className="ios-button px-3 py-1.5 text-xs"
                    data-variant="secondary"
                    disabled={!uploadFile}
                    aria-disabled={!uploadFile}
                    title={uploadFile ? "Download will be wired up in a later step." : "Upload a spreadsheet to enable download."}
                  >
                    Download
                  </button>
                </div>
