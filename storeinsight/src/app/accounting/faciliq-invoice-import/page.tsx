...
export default function FaciliqInvoiceImportPage(): JSX.Element {
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="space-y-3">
              ...
              <p className="max-w-3xl text-sm leading-relaxed text-[color:var(--text-secondary)] sm:text-base">
                Drop in the weekly FacilIQ QuickBooks CSV. Every invoice row is read and checked,
                then the clean rows are split into one import file per property, because L001, P006,
                W002, and W003 each have their own QuickBooks company. Anything missing or
                questionable is held back for review instead of being imported.
              </p>
            </div>
